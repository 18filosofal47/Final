<?php
    ...
    /*
    EXPLAIN SELECT codigo.UltimoNum, muestra.muestra, muestra.contenedor, muestra.total, muestra.protocolo
                         FROM codigo
                         INNER JOIN muestra on codigo.idcodigo=muestra.idmuestra
                EXPLAIN  SELECT codigo.UltimoNum, responsable.appaterno, responsable.apmaterno, responsable.nombre, responsable.fecha, responsable.hora
                         FROM codigo
                         INNER JOIN responsable on codigo.idcodigo=responsable.idResponsable ORDER BY responsable.appaterno
