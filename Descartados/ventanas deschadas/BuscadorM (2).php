										...
										<div class="" style="padding-top: 1em;">
											<nav class="navbar navbar-default" role="navigation">
												...
												<div class="collapse navbar-collapse navbar-ex1-collapse">
													...
													<form class="form-horizontal navbar-form navbar-left" role="form" name="Buscador" method="get" action="../scripts/BuscadorM.php">
														<div class="form-group">
														    <input type="text" class="form-control" placeholder="Buscar" name="Buscar">
														    <input class="btn btn-default" type="reset" value="Enviar"/>
														</div>
													...
													<ul class="nav navbar-nav navbar-right">
														<li>
														    <a class="btn" id="menu-toggle btn" href="#menu-toggle" value = "Agrandar"  onclick=”cambiar();”></a>
														</li>
														<li class="dropdown">
														    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
