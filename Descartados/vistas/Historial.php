							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form class="form-horizontal" role="form" name="forma_historia_clinica" method="post" action="../Funciones/Paciente.php" enctype="multipart/form-data">
										...
										<?php
											...
											{
												require("../Funciones/Paciente.php");
											}
											clearstatcache();
										?>
									</div>
