							...
							<div class="col-lg-12">
								<div class="panel panel-default">
								    ...
								    <div class="panel-body">
									    <form class="form-horizontal" role="form" name="forma_Captura_Muestra" method="post" action="../Funciones/Captura.php">
													...
													<th colspan="2">
														<table class="table table-bordered table-condensed">
															...
															<tr>
																<th rowspan="2">
																	<div>
																	    <?php  /*SELECT LPAD("(MAX(UltimoNum)",3,'0') FROM codigo;*/
																		    require("../scripts/Conexion.php");//haciendo un llamdo a la base de datos/ str_pad($input, 3, "0", STR_PAD_BOTH) . 
																			$consulta = "SELECT substring((MAX(UltimoNum)) , 9, 2) As Maximo FROM codigo";
																			$resultado = mysqli_query($conexion, $consulta);
																			/* array numérico */
																			$row = mysqli_fetch_array($resultado, MYSQLI_NUM);
																			$input = "0";
																			echo "El c&#243;digo es: " . date("Ym") . ("$row[0]"  + 1 ) . str_pad($input, 2, "0", STR_PAD_BOTH) . "<br>";// genera un código de 4 caracteres de longitud.
																			/*
                                                                            // Si el codigo actual esta vacio o es 0, se convierte en 1.
                                                                            // En caso contrario se le suma +1.
                                                                            $codigo = (empty($consulta['UltimoNum']) ? 1 : $consulta['UltimoNum']+=1);
