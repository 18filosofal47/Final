							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form class="form-horizontal" role="form" name="forma_proceso_de_la_muestra" method="post"  action="../Funciones/registrodos.php">
											<table class="table table-condensed table-bordered">	
												...
												<tr>
												    <th><input type="text" class="form-control" placeholder="Folio de la muestra" name="folio" ng-model="folio" required onChange="javascript:this.value=this.value.toUpperCase();"/></th>
										...
										<?php
											...
											{
												require("../Funciones/registrodos.php");
											}
											clearstatcache();
										?>
									</div>
