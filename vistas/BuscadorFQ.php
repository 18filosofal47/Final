		...
		<script>
		    $(document).ready(function() {
				$('#example').DataTable( {
					...
					"serverSide": true,
					"ajax": {
						"url": "../Funciones/FuncionQ.php",// Página destino
						"type": "POST",/* En caso de ser GET o POST*
						data: "nombre=Juan&ciudad=Boston"   // Parámetros a enviar en este caso
						success: function(html){
							$("#results").append(html); //funcion para procesar los datos de retorno
						}*/
					},
					/*"ajax": "../Funciones/FuncionQ.php",	*/
					 "columns": [
						{"data": "idquimico"},
						{"data": "appaterno"},
						{"data": "apmaterno"},
