...
<html lang="es">
	...
	<body>
														    ...
														    <th colspan="2">
																...
																<table class="table table-condensed table-bordered text-center">
																	<tr>
																		...
																		<th>
																			<input type="button" id="Editar" value="Editar" class="btn btn-primary btn-ok"/>
																		</th>
																	</tr>
																	<tr>
																		<th>&#191;Desea eliminar este registro?</th>
																		<th>
																			<input type="button" id="Eliminar" value="Eliminar" class="btn btn-danger btn-ok"/>
																		</th>
																	</tr>
																</table>
														    </th>
		...
		<!-- JavaScript PopUp o ventana emergente-->
		<!--JavaScript-->
		...
		<script type="text/javascript">
			$("#menu-toggle").click(function(e) {
				...
				$("#menu-toggle").attr('value', 'Agrandar');
